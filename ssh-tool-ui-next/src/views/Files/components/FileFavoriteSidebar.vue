...
<template>
  <div class="favorite-sidebar-shell relative hidden min-h-0 shrink-0 transition-[width] duration-[220ms] ease-in-out md:flex"
    ...
    <aside
      ...
      :class="[
        settingsStore.isDark ? 'border-[rgba(148,163,184,0.14)] bg-[rgba(15,23,42,0.72)]' : 'border-[rgba(148,163,184,0.22)] bg-[rgba(248,250,252,0.84)]',
      ...
      <div class="min-h-0 flex-1 px-[10px] pb-[12px]">
        ...
        <NScrollbar v-else class="h-full">
          <div class="flex flex-col gap-[8px] pr-[4px]">
            ...
            >
              <button type="button" class="btn-reset truncate-line min-w-0 text-left" :title="path"
      ...
      <NTooltip placement="right">
        <template #trigger>
          <div
            ...
            :class="settingsStore.isDark ? 'bg-[rgba(15,23,42,0.96)] text-[rgba(148,163,184,0.96)] shadow-[0_2px_4px_rgba(2,6,23,0.22)] hover:bg-[rgba(30,41,59,0.98)] hover:text-[rgba(191,219,254,0.96)]' : 'bg-[rgba(255,255,255,0.98)] text-[rgba(100,116,139,0.96)] shadow-[0_2px_4px_rgba(15,23,42,0.12)] hover:bg-[rgba(255,255,255,1)] hover:text-[rgba(37,99,235,0.96)]'"
