...
<template>
  ...
  >
    ...
    <div class="min-h-0 flex-1 overflow-auto p-[18px] app-scrollbar" :class="settingsStore.isDark ? 'app-scrollbar-dark' : 'app-scrollbar-light'">
      <NForm label-placement="top">
        ...
        <NFormItem label="远端工作目录" required>
