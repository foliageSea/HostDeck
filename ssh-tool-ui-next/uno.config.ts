...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'glass-panel-dark': 'border border-[rgba(148,163,184,0.18)] bg-[rgba(15,23,42,0.58)] backdrop-blur-[18px] shadow-[0_24px_70px_rgba(15,23,42,0.35)]',
    'glass-panel-light': 'border border-[rgba(148,163,184,0.22)] bg-[rgba(255,255,255,0.72)] shadow-[0_24px_70px_rgba(148,163,184,0.2)]',
    'glass-surface-dark': 'border border-[rgba(148,163,184,0.16)] bg-[rgba(15,23,42,0.56)] backdrop-blur-[16px]',
