...
List<_OperationPolicy> _policies(
  ...
  _OperationPolicy(
    'PUT',
    r'api/ai-agent/settings',
    'aiAgent',
    'settingsUpdate',
  ),
  _OperationPolicy(
    'POST',
    r'api/ai-agent/settings/test',
    'aiAgent',
    'settingsTest',
  ),
  ...
  _OperationPolicy(
    'POST',
    r'api/ai-agent/mcp-servers/([^/]+)/test',
    'aiAgent',
    'mcpServerTest',
  ),
  _OperationPolicy(
  ...
  _OperationPolicy(
    'POST',
    r'api/ai-agent/conversations/([^/]+)/runs',
    'aiAgent',
    'run',
  ),
  _OperationPolicy(
    'POST',
    r'api/ai-agent/runs/([^/]+)/approve',
    'aiAgent',
    'approve',
  ),
  _OperationPolicy(
    'POST',
    r'api/ai-agent/runs/([^/]+)/reject',
    'aiAgent',
    'reject',
  ),
  _OperationPolicy('DELETE', r'api/ai-agent/runs/([^/]+)', 'aiAgent', 'cancel'),
  _OperationPolicy(
    'POST',
    r'api/servers',
    'server',
